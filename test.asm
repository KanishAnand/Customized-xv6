...
int main(int argc, char *argv[]) {
  1c:	8b 41 04             	mov    0x4(%ecx),%eax
    if (argc < 2)
  1f:	0f 8f 10 01 00 00    	jg     135 <main+0x135>
        n = 1;  // default value
  ...
  30:	0f 84 1e 01 00 00    	je     154 <main+0x154>
    for (k = 0; k < n; k++) {
  36:	83 c6 01             	add    $0x1,%esi
  39:	39 de                	cmp    %ebx,%esi
  3b:	7d 28                	jge    65 <main+0x65>
        id = fork();
  3d:	e8 88 03 00 00       	call   3ca <fork>
        if (id < 0) {
  42:	85 c0                	test   %eax,%eax
  44:	79 ea                	jns    30 <main+0x30>
            printf(1, "%d failed in fork!\n", getpid());
  46:	e8 07 04 00 00       	call   452 <getpid>
  4b:	83 ec 04             	sub    $0x4,%esp
    for (k = 0; k < n; k++) {
  4e:	83 c6 01             	add    $0x1,%esi
            printf(1, "%d failed in fork!\n", getpid());
  51:	50                   	push   %eax
  52:	68 88 08 00 00       	push   $0x888
  57:	6a 01                	push   $0x1
  ...
  73:	83 c6 01             	add    $0x1,%esi
            printf(1, "Process not found\n");
  76:	68 b5 08 00 00       	push   $0x8b5
  7b:	6a 01                	push   $0x1
  7d:	e8 ae 04 00 00       	call   530 <printf>
  82:	83 c4 10             	add    $0x10,%esp
    for (k = 0; k < n; k++) {
  85:	39 de                	cmp    %ebx,%esi
  87:	0f 84 a3 00 00 00    	je     130 <main+0x130>
        waitx(&a, &b);
  ...
  97:	50                   	push   %eax
  98:	e8 d5 03 00 00       	call   472 <waitx>
        printf(1, "Wait time : %d  Run Time : %d\n", a, b);
  9d:	ff 75 c0             	pushl  -0x40(%ebp)
  a0:	ff 75 bc             	pushl  -0x44(%ebp)
  a3:	68 c8 08 00 00       	push   $0x8c8
  a8:	6a 01                	push   $0x1
  aa:	e8 81 04 00 00       	call   530 <printf>
        int c = getpinfo(&q, pd);
  af:	83 c4 18             	add    $0x18,%esp
  b2:	6a 04                	push   $0x4
  b4:	57                   	push   %edi
  b5:	e8 c8 03 00 00       	call   482 <getpinfo>
        if (c == 1) {
  ba:	83 c4 10             	add    $0x10,%esp
  bd:	83 f8 01             	cmp    $0x1,%eax
  c0:	75 ae                	jne    70 <main+0x70>
            printf(1,
  c2:	83 ec 08             	sub    $0x8,%esp
  c5:	ff 75 d0             	pushl  -0x30(%ebp)
  c8:	ff 75 cc             	pushl  -0x34(%ebp)
  cb:	ff 75 c8             	pushl  -0x38(%ebp)
  ce:	ff 75 c4             	pushl  -0x3c(%ebp)
  d1:	68 e8 08 00 00       	push   $0x8e8
  d6:	6a 01                	push   $0x1
  d8:	e8 53 04 00 00       	call   530 <printf>
            printf(1, "Ticks in ");
  dd:	83 c4 18             	add    $0x18,%esp
  e0:	68 9c 08 00 00       	push   $0x89c
  e5:	6a 01                	push   $0x1
  ...
  ef:	31 c0                	xor    %eax,%eax
                printf(1, "queue %d : %d ", j, q.ticks[j]);
  f1:	ff 74 87 10          	pushl  0x10(%edi,%eax,4)
  f5:	50                   	push   %eax
  f6:	68 a6 08 00 00       	push   $0x8a6
  fb:	6a 01                	push   $0x1
  fd:	89 45 b4             	mov    %eax,-0x4c(%ebp)
 100:	e8 2b 04 00 00       	call   530 <printf>
            for (int j = 0; j < 5; j++) {
 105:	8b 45 b4             	mov    -0x4c(%ebp),%eax
 108:	83 c4 10             	add    $0x10,%esp
 10b:	83 c0 01             	add    $0x1,%eax
 10e:	83 f8 05             	cmp    $0x5,%eax
 111:	75 de                	jne    f1 <main+0xf1>
            printf(1, "\n");
 113:	83 ec 08             	sub    $0x8,%esp
    for (k = 0; k < n; k++) {
 116:	83 c6 01             	add    $0x1,%esi
            printf(1, "\n");
 119:	68 9a 08 00 00       	push   $0x89a
 11e:	6a 01                	push   $0x1
 120:	e8 0b 04 00 00       	call   530 <printf>
 125:	83 c4 10             	add    $0x10,%esp
    for (k = 0; k < n; k++) {
 128:	39 de                	cmp    %ebx,%esi
 12a:	0f 85 5d ff ff ff    	jne    8d <main+0x8d>
            exit();
 130:	e8 9d 02 00 00       	call   3d2 <exit>
        n = atoi(argv[1]);  // from command line
 135:	83 ec 0c             	sub    $0xc,%esp
 138:	ff 70 04             	pushl  0x4(%eax)
 13b:	e8 20 02 00 00       	call   360 <atoi>
    if (n < 0 || n > 20)
 140:	83 c4 10             	add    $0x10,%esp
 143:	83 f8 14             	cmp    $0x14,%eax
        n = atoi(argv[1]);  // from command line
 146:	89 c3                	mov    %eax,%ebx
    if (n < 0 || n > 20)
 148:	76 28                	jbe    172 <main+0x172>
        n = 2;
 14a:	bb 02 00 00 00       	mov    $0x2,%ebx
 14f:	e9 d1 fe ff ff       	jmp    25 <main+0x25>
            for (z = 0; z < 3000000.0; z += 0.1)
 154:	d9 ee                	fldz   
 156:	dd 05 20 09 00 00    	fldl   0x920
 15c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 160:	dc c1                	fadd   %st,%st(1)
 162:	d9 05 28 09 00 00    	flds   0x928
 168:	df ea                	fucomip %st(2),%st
 16a:	77 f4                	ja     160 <main+0x160>
 16c:	dd d8                	fstp   %st(0)
 16e:	dd d8                	fstp   %st(0)
 170:	eb be                	jmp    130 <main+0x130>
    for (k = 0; k < n; k++) {
 172:	85 c0                	test   %eax,%eax
 174:	0f 85 ab fe ff ff    	jne    25 <main+0x25>
 17a:	eb b4                	jmp    130 <main+0x130>
 ...
 499:	85 d2                	test   %edx,%edx
{
 ...
 4c7:	f7 f1                	div    %ecx
 4c9:	0f b6 92 34 09 00 00 	movzbl 0x934(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	e9 8f fe ff ff       	jmp    578 <printf+0x48>
          s = "(null)";
 6e9:	bb 2c 09 00 00       	mov    $0x92c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 73d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 73f:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 744:	5b                   	pop    %ebx
 745:	5e                   	pop    %esi
 746:	5f                   	pop    %edi
 ...
 756:	72 ce                	jb     726 <free+0x26>
{
 ...
 777:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 77a:	a3 e4 0b 00 00       	mov    %eax,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 47                	jae    828 <malloc+0x98>
    ...
    if(p == freep)
 7e1:	39 05 e4 0b 00 00    	cmp    %eax,0xbe4
 ...
 806:	e8 f5 fe ff ff       	call   700 <free>
  return freep;
 80b:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
 ...
 834:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 837:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 ...
 849:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 857:	0b 00 00 
 85a:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 861:	0b 00 00 
    base.s.size = 0;
 864:	b8 e8 0b 00 00       	mov    $0xbe8,%eax
 869:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 870:	00 00 00 
